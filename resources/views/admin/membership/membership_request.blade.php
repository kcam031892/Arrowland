...
<div class="row">
    <div class="col-xl-12">
        <div class="breadcrumb-holder">
                              <h1 class="main-title float-left">Membership</h1>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
      <div class="card mb-3">
        <div class="card-header">
          <h3><i class="fa fa-table"></i> Membership Request List</h3>
              ...
              @foreach($membership as $data)
                <tr id="{{$data->id}}">
                  ...
                  <td>
                    ...
                    <a href="javascript:" rel="{{$data->id}}" class="btn btn-danger btn-sm cancel">Cancel</a>
...
$(".cancel").on('click',function(){
  ...
  if (result.value) {
    window.location.href="/admin/membership/cancel/"+id;
    // swal(
    //   'Deleted',
...
$(".accept").on('click',function(){
    ...
    if (result.value) {
      window.location.href="/admin/membership/accept/"+id;
      // swal(
      //   'Deleted',
      //   'Your image has been deleted!',
      //   'success'
